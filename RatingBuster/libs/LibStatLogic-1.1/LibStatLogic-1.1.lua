...
Last Update: $Date: 2010-03-20 14:09:28 +0000 (Sat, 20 Mar 2010) $
Website:
Documentation:
SVN: $URL $
Dependencies: UTF8
...
Example:
	...
	local apPerAgi = StatLogic:GetAPPerAgi("DRUID")
-----------------------------------]]
...
local SpellCritPerInt = {
	--WARRIOR, PALADIN, HUNTER, DRUID, PRIEST, DEATHKNIGHT, SHAMAN, MAGE, WARLOCK, DRUID
